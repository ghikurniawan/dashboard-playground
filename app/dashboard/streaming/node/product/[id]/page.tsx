...
} from '#/app/dashboard/streaming/_components/recommended-products';
import {
  Reviews,
  ReviewsSkeleton,
} from '#/app/dashboard/streaming/_components/reviews';
import { SingleProduct } from '#/app/dashboard/streaming/_components/single-product';
